...
namespace CS322_PZ
{
	partial class ZakaziPosetu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Zakaži posetu";
			...
			// monthCalendar1
			// 
			this.monthCalendar1.Location = new System.Drawing.Point(321, 93);
			...
			this.Name = "ZakaziPosetu";
			this.Text = "ZakaziPosetu";
